...
**v2 (in progress):** [Tonight](docs/v2-plan.md) — one screen for “what should I cook right now?” Nav + Use it up + today’s plan shipped 2 Sep; recipe groups shipped 3 Sep; gaps list still coming.
