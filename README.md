...
**v2 (in progress):** [Tonight](docs/v2-plan.md) — one screen for “what should I cook right now?” Nav + Use it up + today’s plan shipped 2 Sep; recipe groups shipped 3 Sep; gaps list (**What’s missing**) shipped 6 Sep; **Uses expiring items** badge on Ready / Almost ready shipped 7 Sep; load errors + Try again shipped 8 Sep.
